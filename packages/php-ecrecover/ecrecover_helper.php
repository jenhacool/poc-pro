<?php
require_once dirname( __DIR__ ) . '/cryptocurrency-php/PointMathGMP.class.php';
require_once dirname( __DIR__ ) .  '/cryptocurrency-php/SECp256k1.class.php';
require_once dirname( __DIR__ ) .  '/cryptocurrency-php/Signature.class.php';
